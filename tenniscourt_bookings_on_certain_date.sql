...
WHERE starttime BETWEEN '2012-09-21' AND '2012-09-22' -- return only bookings on this date
AND facilities.name LIKE '%Tennis Court%' -- return only tennis courts
ORDER BY starttime -- ordered by time
